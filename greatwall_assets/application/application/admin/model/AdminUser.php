...
class AdminUser extends Model {
     ...
     */
    public function add(){
        $newarr['username'] = $_POST['userid'];
        $newarr['nicename'] = $_POST['username'];
        $newarr['email'] = $_POST['email'];
        $newarr['group_id'] = $_POST['group_id'];
        $newarr['status'] =  $_POST['status'];
        $newarr['password']=md5($_POST['password']);
        $newarr['reg_time']=time();
        return $this->allowField(true)->save($newarr);
    }
    /**
     * 更新
     */
    public function edit(){
		...
		if (isset($_POST['password']) && !empty($_POST['password'])){
			$newarr['password']=$_POST['password'];
		}
        ...
        return $this->allowField(true)->save($newarr,$where);
    }
     ...
     * return false
     */
    public function delinfo($username){
        $map = array();
        $map['username'] = $username;
        return $this->where($map)->delete();
    }
