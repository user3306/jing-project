...
class AssetType extends Model{
	//获取资产列表
	public function getAssetTypeList($where = array(), $limit = 0,$searchinfo = array()){
		return $this->name('asset_type2019')
                ->alias('a')
                ->join('asset_type2019 t','a.pid=t.id','left')
                ->where($where)
                ->field('a.assettype,a.id,t.assettype as parentname,a.addtime,a.is_status,a.sort')->paginate($limit,false,['query'=>$searchinfo]);
	}
