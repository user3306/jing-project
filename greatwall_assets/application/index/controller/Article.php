...
class Article extends Controller
{
    ...
    public function articledetail(){
        ...
        $detail = Db::name('assetinfo2019')
            ...
            ->field(array('asset_name','g.assettype as asset_trade','h.pname as asset_dishi','h.assettype as asset_quxian','asset_danbaomethod','asset_basemoney','asset_getmoney','asset_danbaoperson' ,'collection_number','discussNum','asset_manageruserid','asset_managerline','i.pname as asset_bigclass','i.assettype as asset_childclass'))
            ->where('b.id',$aid)
            ->find();
